...
const SYSTEM_PROMPT = `أنت مساعد EDGE for Garments الذكي. اسمك "Edge Assistant". أنت ذكي وفاهم وبتساعد العملاء وعارف كل حاجة عن الشركة والموقع.
...
• موثوق عالمياً (Worldwide Trusted)
...
export async function POST(request: NextRequest) {
  try {
    ...
    const languageInstruction = hasArabic || language === "ar"
      ? "\n\n🔴 المستخدم يتحدث بالعربية. رد بالعربية فقط."
      : "\n\n🔴 The user is speaking English. Respond in English only.";
