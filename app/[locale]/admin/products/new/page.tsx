      ...
      <header className="bg-white border-b border-slate-200 px-6 py-4 sticky top-0 z-30">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold text-slate-800">{t.addProduct}</h1>
          </div>
          <button onClick={() => router.push(`/${locale === "ar" ? "en" : "ar"}/admin/products/new`)} className="px-3 py-1.5 text-sm text-slate-600 hover:text-slate-800 border border-slate-300 rounded-lg hover:bg-slate-50 transition-all">
            {locale === "ar" ? "EN" : "AR"}
          </button>
        </div>
      </header>
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" value={formData.slug} onChange={(e) => setFormData({ ...formData, slug: e.target.value })} className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" placeholder="auto-generated" dir="ltr" />
                </div>
                <div>
