        ...
        <ScrollReveal delay={300}>
          <div className="flex justify-center mt-14">
            <a
              href="/catalog.pdf"
              download
              className={`inline-flex items-center gap-3 px-8 py-4 bg-true-cobalt text-white font-semibold rounded-lg hover:bg-royal-azure transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5 ${
                isRTL ? "flex-row-reverse font-[var(--font-cairo)]" : ""
              }`}
            >
              <svg
